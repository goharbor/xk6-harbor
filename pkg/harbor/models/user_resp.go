...
type UserResp struct {
	...
	AdminRoleInAuth bool `json:"admin_role_in_auth" js:"adminRoleInAuth"`
	...
	// oidc user meta
	OIDCUserMeta *OIDCUserInfo `json:"oidc_user_meta,omitempty" js:"oidcUserMeta"`

	// realname
	Realname string `json:"realname,omitempty" js:"realname"`

	// sysadmin flag
	SysadminFlag bool `json:"sysadmin_flag" js:"sysadminFlag"`
	...
	// user id
	UserID int64 `json:"user_id,omitempty" js:"userID"`
