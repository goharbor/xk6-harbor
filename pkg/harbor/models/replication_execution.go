...
type ReplicationExecution struct {
	...
	Failed int64 `json:"failed" js:"failed"`

	// The ID of the execution
	ID int64 `json:"id,omitempty" js:"id"`

	// The count of in_progress executions
	InProgress int64 `json:"in_progress" js:"inProgress"`
	...
	// The status text
	StatusText string `json:"status_text" js:"statusText"`

	// The count of stopped executions
	Stopped int64 `json:"stopped" js:"stopped"`

	// The count of succeed executions
	Succeed int64 `json:"succeed" js:"succeed"`
