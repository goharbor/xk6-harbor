...
type RetentionRule struct {
	...
	// params
	Params map[string]interface{} `json:"params,omitempty" js:"params"`

	// priority
	Priority int64 `json:"priority,omitempty" js:"priority"`

	// scope selectors
	ScopeSelectors map[string][]RetentionSelector `json:"scope_selectors,omitempty" js:"scopeSelectors"`

	// tag selectors
	TagSelectors []*RetentionSelector `json:"tag_selectors" js:"tagSelectors"`
