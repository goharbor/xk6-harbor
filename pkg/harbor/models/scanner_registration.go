...
type ScannerRegistration struct {
	...
	// Format: date-time
	CreateTime strfmt.DateTime `json:"create_time,omitempty" js:"createTime"`
	...
	Disabled *bool `json:"disabled" js:"disabled"`

	// Indicate the healthy of the registration
	// Example: healthy
	Health string `json:"health,omitempty" js:"health"`

	// Indicate if the registration is set as the system default one
	IsDefault *bool `json:"is_default" js:"isDefault"`
	...
	SkipCertVerify *bool `json:"skip_certVerify" js:"skipCertVerify"`
	...
	UUID string `json:"uuid,omitempty" js:"uuid"`
