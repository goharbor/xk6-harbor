...
type RegistryUpdate struct {
	...
	AccessKey *string `json:"access_key,omitempty" js:"accessKey"`

	// The registry access secret.
	AccessSecret *string `json:"access_secret,omitempty" js:"accessSecret"`

	// Credential type of the registry, e.g. 'basic'.
	CredentialType *string `json:"credential_type,omitempty" js:"credentialType"`
