...
type ImmutableRule struct {
	...
	// scope selectors
	ScopeSelectors map[string][]ImmutableSelector `json:"scope_selectors,omitempty" js:"scopeSelectors"`

	// tag selectors
	TagSelectors []*ImmutableSelector `json:"tag_selectors" js:"tagSelectors"`
