...
type Platform struct {
	...
	OsFeatures []string `json:"'os.features'" js:"osFeatures"`

	// The version of the OS that the artifact applys to
	OsVersion string `json:"'os.version',omitempty" js:"osVersion"`

	// The architecture that the artifact applys to
	Architecture string `json:"architecture,omitempty" js:"architecture"`

	// The OS that the artifact applys to
	Os string `json:"os,omitempty" js:"os"`

	// The variant of the CPU
	Variant string `json:"variant,omitempty" js:"variant"`
}
