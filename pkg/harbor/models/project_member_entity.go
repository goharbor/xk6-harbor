...
type ProjectMemberEntity struct {
	...
	EntityID int64 `json:"entity_id,omitempty" js:"entityID"`

	// the name of the group member.
	EntityName string `json:"entity_name,omitempty" js:"entityName"`

	// the entity's type, u for user entity, g for group entity.
	EntityType string `json:"entity_type,omitempty" js:"entityType"`
	...
	// the role id
	RoleID int64 `json:"role_id,omitempty" js:"roleID"`

	// the name of the role
	RoleName string `json:"role_name,omitempty" js:"roleName"`
}
