...
type ProjectSummary struct {
	...
	GuestCount int64 `json:"guest_count,omitempty" js:"guestCount"`

	// The total number of limited guest members.
	LimitedGuestCount int64 `json:"limited_guest_count,omitempty" js:"limitedGuestCount"`

	// The total number of maintainer members.
	MaintainerCount int64 `json:"maintainer_count,omitempty" js:"maintainerCount"`

	// The total number of project admin members.
	ProjectAdminCount int64 `json:"project_admin_count,omitempty" js:"projectAdminCount"`

	// quota
	Quota *ProjectSummaryQuota `json:"quota,omitempty" js:"quota"`
