...
type RetentionMetadata struct {
	...
	ScopeSelectors []*RetentionSelectorMetadata `json:"scope_selectors" js:"scopeSelectors"`

	// supported tag selectors
	TagSelectors []*RetentionSelectorMetadata `json:"tag_selectors" js:"tagSelectors"`

	// templates
	Templates []*RetentionRuleMetadata `json:"templates" js:"templates"`
}
