...
type JobQueue struct {
	...
	Count int64 `json:"count,omitempty" js:"count"`

	// The type of the job queue
	JobType string `json:"job_type,omitempty" js:"jobType"`

	// The latency the job queue (seconds)
	Latency int64 `json:"latency,omitempty" js:"latency"`

	// The paused status of the job queue
	Paused bool `json:"paused" js:"paused"`
}
