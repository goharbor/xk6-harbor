...
type ConfigurationsResponse struct {
	...
	AuditLogForwardEndpoint *StringConfigItem `json:"audit_log_forward_endpoint,omitempty" js:"auditLogForwardEndpoint"`

	// The auth mode of current system, such as "db_auth", "ldap_auth", "oidc_auth"
	AuthMode *StringConfigItem `json:"auth_mode,omitempty" js:"authMode"`

	// The banner message for the UI.It is the stringified result of the banner message object
	BannerMessage *StringConfigItem `json:"banner_message,omitempty" js:"bannerMessage"`

	// The group which has the harbor admin privileges
	HTTPAuthproxyAdminGroups *StringConfigItem `json:"http_authproxy_admin_groups,omitempty" js:"httpAuthproxyAdminGroups"`

	// The usernames which has the harbor admin privileges
	HTTPAuthproxyAdminUsernames *StringConfigItem `json:"http_authproxy_admin_usernames,omitempty" js:"httpAuthproxyAdminUsernames"`

	// The endpoint of the HTTP auth
	HTTPAuthproxyEndpoint *StringConfigItem `json:"http_authproxy_endpoint,omitempty" js:"httpAuthproxyEndpoint"`

	// The certificate of the HTTP auth provider
	HTTPAuthproxyServerCertificate *StringConfigItem `json:"http_authproxy_server_certificate,omitempty" js:"httpAuthproxyServerCertificate"`

	// Search user before onboard
	HTTPAuthproxySkipSearch *BoolConfigItem `json:"http_authproxy_skip_search,omitempty" js:"httpAuthproxySkipSearch"`

	// The token review endpoint
	HTTPAuthproxyTokenreviewEndpoint *StringConfigItem `json:"http_authproxy_tokenreview_endpoint,omitempty" js:"httpAuthproxyTokenreviewEndpoint"`

	// Verify the HTTP auth provider's certificate
	HTTPAuthproxyVerifyCert *BoolConfigItem `json:"http_authproxy_verify_cert,omitempty" js:"httpAuthproxyVerifyCert"`

	// The Base DN for LDAP binding.
	LdapBaseDn *StringConfigItem `json:"ldap_base_dn,omitempty" js:"ldapBaseDn"`

	// The filter for LDAP search
	LdapFilter *StringConfigItem `json:"ldap_filter,omitempty" js:"ldapFilter"`

	// Specify the ldap group which have the same privilege with Harbor admin
	LdapGroupAdminDn *StringConfigItem `json:"ldap_group_admin_dn,omitempty" js:"ldapGroupAdminDn"`

	// The attribute which is used as identity of the LDAP group, default is cn.'
	LdapGroupAttributeName *StringConfigItem `json:"ldap_group_attribute_name,omitempty" js:"ldapGroupAttributeName"`

	// The base DN to search LDAP group.
	LdapGroupBaseDn *StringConfigItem `json:"ldap_group_base_dn,omitempty" js:"ldapGroupBaseDn"`

	// The user attribute to identify the group membership
	LdapGroupMembershipAttribute *StringConfigItem `json:"ldap_group_membership_attribute,omitempty" js:"ldapGroupMembershipAttribute"`

	// The filter to search the ldap group
	LdapGroupSearchFilter *StringConfigItem `json:"ldap_group_search_filter,omitempty" js:"ldapGroupSearchFilter"`

	// The scope to search ldap group. ''0-LDAP_SCOPE_BASE, 1-LDAP_SCOPE_ONELEVEL, 2-LDAP_SCOPE_SUBTREE''
	LdapGroupSearchScope *IntegerConfigItem `json:"ldap_group_search_scope,omitempty" js:"ldapGroupSearchScope"`

	// The scope to search ldap users,'0-LDAP_SCOPE_BASE, 1-LDAP_SCOPE_ONELEVEL, 2-LDAP_SCOPE_SUBTREE'
	LdapScope *IntegerConfigItem `json:"ldap_scope,omitempty" js:"ldapScope"`

	// The DN of the user to do the search.
	LdapSearchDn *StringConfigItem `json:"ldap_search_dn,omitempty" js:"ldapSearchDn"`

	// Timeout in seconds for connection to LDAP server
	LdapTimeout *IntegerConfigItem `json:"ldap_timeout,omitempty" js:"ldapTimeout"`

	// The attribute which is used as identity for the LDAP binding, such as "CN" or "SAMAccountname"
	LdapUID *StringConfigItem `json:"ldap_uid,omitempty" js:"ldapUID"`

	// The URL of LDAP server
	LdapURL *StringConfigItem `json:"ldap_url,omitempty" js:"ldapURL"`

	// Whether verify your OIDC server certificate, disable it if your OIDC server is hosted via self-hosted certificate.
	LdapVerifyCert *BoolConfigItem `json:"ldap_verify_cert,omitempty" js:"ldapVerifyCert"`

	// Enable notification
	NotificationEnable *BoolConfigItem `json:"notification_enable,omitempty" js:"notificationEnable"`

	// The OIDC group which has the harbor admin privileges
	OIDCAdminGroup *StringConfigItem `json:"oidc_admin_group,omitempty" js:"oidcAdminGroup"`

	// Auto onboard the OIDC user
	OIDCAutoOnboard *BoolConfigItem `json:"oidc_auto_onboard,omitempty" js:"oidcAutoOnboard"`

	// The client ID of the OIDC provider
	OIDCClientID *StringConfigItem `json:"oidc_client_id,omitempty" js:"oidcClientID"`

	// The endpoint of the OIDC provider
	OIDCEndpoint *StringConfigItem `json:"oidc_endpoint,omitempty" js:"oidcEndpoint"`

	// Extra parameters to add when redirect request to OIDC provider
	OIDCExtraRedirectParms *StringConfigItem `json:"oidc_extra_redirect_parms,omitempty" js:"oidcExtraRedirectParms"`

	// The OIDC group filter which filters out the group doesn't match the regular expression
	OIDCGroupFilter *StringConfigItem `json:"oidc_group_filter,omitempty" js:"oidcGroupFilter"`

	// The attribute claims the group name
	OIDCGroupsClaim *StringConfigItem `json:"oidc_groups_claim,omitempty" js:"oidcGroupsClaim"`

	// The OIDC provider name
	OIDCName *StringConfigItem `json:"oidc_name,omitempty" js:"oidcName"`

	// The scope of the OIDC provider
	OIDCScope *StringConfigItem `json:"oidc_scope,omitempty" js:"oidcScope"`

	// The attribute claims the username
	OIDCUserClaim *StringConfigItem `json:"oidc_user_claim,omitempty" js:"oidcUserClaim"`

	// Verify the OIDC provider's certificate'
	OIDCVerifyCert *BoolConfigItem `json:"oidc_verify_cert,omitempty" js:"oidcVerifyCert"`

	// The flag to indicate whether the current auth mode should consider as a primary one.
	PrimaryAuthMode *BoolConfigItem `json:"primary_auth_mode,omitempty" js:"primaryAuthMode"`

	// Indicate who can create projects, it could be ''adminonly'' or ''everyone''.
	ProjectCreationRestriction *StringConfigItem `json:"project_creation_restriction,omitempty" js:"projectCreationRestriction"`

	// Enable quota per project
	QuotaPerProjectEnable *BoolConfigItem `json:"quota_per_project_enable,omitempty" js:"quotaPerProjectEnable"`

	// The flag to indicate whether Harbor is in readonly mode.
	ReadOnly *BoolConfigItem `json:"read_only,omitempty" js:"readOnly"`

	// The rebot account name prefix
	RobotNamePrefix *StringConfigItem `json:"robot_name_prefix,omitempty" js:"robotNamePrefix"`

	// The robot account token duration in days
	RobotTokenDuration *IntegerConfigItem `json:"robot_token_duration,omitempty" js:"robotTokenDuration"`

	// scan all policy
	ScanAllPolicy *ConfigurationsResponseScanAllPolicy `json:"scan_all_policy,omitempty" js:"scanAllPolicy"`

	// Whether or not to skip update the pull time for scanner
	ScannerSkipUpdatePulltime *BoolConfigItem `json:"scanner_skip_update_pulltime,omitempty" js:"scannerSkipUpdatePulltime"`

	// Whether the Harbor instance supports self-registration.  If it''s set to false, admin need to add user to the instance.
	SelfRegistration *BoolConfigItem `json:"self_registration,omitempty" js:"selfRegistration"`

	// The session timeout in minutes
	SessionTimeout *IntegerConfigItem `json:"session_timeout,omitempty" js:"sessionTimeout"`

	// Whether skip the audit log in database
	SkipAuditLogDatabase *BoolConfigItem `json:"skip_audit_log_database,omitempty" js:"skipAuditLogDatabase"`

	// The storage quota per project
	StoragePerProject *IntegerConfigItem `json:"storage_per_project,omitempty" js:"storagePerProject"`

	// The expiration time of the token for internal Registry, in minutes.
	TokenExpiration *IntegerConfigItem `json:"token_expiration,omitempty" js:"tokenExpiration"`

	// The client id of UAA
	UaaClientID *StringConfigItem `json:"uaa_client_id,omitempty" js:"uaaClientID"`

	// The client secret of the UAA
	UaaClientSecret *StringConfigItem `json:"uaa_client_secret,omitempty" js:"uaaClientSecret"`

	// The endpoint of the UAA
	UaaEndpoint *StringConfigItem `json:"uaa_endpoint,omitempty" js:"uaaEndpoint"`

	// Verify the certificate in UAA server
	UaaVerifyCert *BoolConfigItem `json:"uaa_verify_cert,omitempty" js:"uaaVerifyCert"`
}
...
type ConfigurationsResponseScanAllPolicy struct {
	...
	// parameter
	Parameter *ConfigurationsResponseScanAllPolicyParameter `json:"parameter,omitempty" js:"parameter"`
...
type ConfigurationsResponseScanAllPolicyParameter struct {
	...
	DailyTime int64 `json:"daily_time,omitempty" js:"dailyTime"`
}
