...
type RetentionPolicy struct {
	...
	// algorithm
	Algorithm string `json:"algorithm,omitempty" js:"algorithm"`

	// id
	ID int64 `json:"id,omitempty" js:"id"`

	// rules
	Rules []*RetentionRule `json:"rules" js:"rules"`

	// scope
	Scope *RetentionPolicyScope `json:"scope,omitempty" js:"scope"`

	// trigger
	Trigger *RetentionRuleTrigger `json:"trigger,omitempty" js:"trigger"`
}
