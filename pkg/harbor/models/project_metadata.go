...
type ProjectMetadata struct {
	...
	Public string `json:"public,omitempty" js:"public"`

	// The ID of the tag retention policy for the project
	RetentionID *string `json:"retention_id,omitempty" js:"retentionID"`
	...
	ReuseSysCVEAllowlist *string `json:"reuse_sys_cve_allowlist,omitempty" js:"reuseSysCVEAllowlist"`
