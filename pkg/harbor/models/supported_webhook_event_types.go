...
type SupportedWebhookEventTypes struct {
	...
	// event type
	EventType []EventType `json:"event_type" js:"eventType"`

	// notify type
	NotifyType []NotifyType `json:"notify_type" js:"notifyType"`

	// payload formats
	PayloadFormats []*PayloadFormat `json:"payload_formats" js:"payloadFormats"`
}
