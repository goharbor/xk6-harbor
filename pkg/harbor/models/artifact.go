...
type Artifact struct {
	...
	// labels
	Labels []*Label `json:"labels" js:"labels"`

	// The manifest media type of the artifact
	ManifestMediaType string `json:"manifest_media_type,omitempty" js:"manifestMediaType"`

	// The media type of the artifact
	MediaType string `json:"media_type,omitempty" js:"mediaType"`
	...
	// references
	References []*Reference `json:"references" js:"references"`
	...
	Size int64 `json:"size,omitempty" js:"size"`

	// tags
	Tags []*Tag `json:"tags" js:"tags"`
