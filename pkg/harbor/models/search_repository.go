...
type SearchRepository struct {
	...
	ArtifactCount int64 `json:"artifact_count,omitempty" js:"artifactCount"`

	// The ID of the project that the repository belongs to
	ProjectID int64 `json:"project_id,omitempty" js:"projectID"`

	// The name of the project that the repository belongs to
	ProjectName string `json:"project_name,omitempty" js:"projectName"`

	// The flag to indicate the publicity of the project that the repository belongs to (1 is public, 0 is not)
	ProjectPublic bool `json:"project_public,omitempty" js:"projectPublic"`

	// The count how many times the repository is pulled
	PullCount int64 `json:"pull_count,omitempty" js:"pullCount"`
