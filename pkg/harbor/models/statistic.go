...
type Statistic struct {
	...
	PrivateProjectCount int64 `json:"private_project_count" js:"privateProjectCount"`

	// The count of the private repositories
	PrivateRepoCount int64 `json:"private_repo_count" js:"privateRepoCount"`

	// The count of the public projects
	PublicProjectCount int64 `json:"public_project_count" js:"publicProjectCount"`

	// The count of the public repositories
	PublicRepoCount int64 `json:"public_repo_count" js:"publicRepoCount"`

	// The count of the total projects, only be seen by the system admin
	TotalProjectCount int64 `json:"total_project_count" js:"totalProjectCount"`

	// The count of the total repositories, only be seen by the system admin
	TotalRepoCount int64 `json:"total_repo_count" js:"totalRepoCount"`

	// The total storage consumption of blobs, only be seen by the system admin
	TotalStorageConsumption int64 `json:"total_storage_consumption" js:"totalStorageConsumption"`
}
