...
type WebhookLastTrigger struct {
	...
	EventType string `json:"event_type,omitempty" js:"eventType"`

	// The last trigger time of webhook policy.
	// Format: date-time
	LastTriggerTime strfmt.DateTime `json:"last_trigger_time,omitempty" js:"lastTriggerTime"`

	// The webhook policy name.
	PolicyName string `json:"policy_name,omitempty" js:"policyName"`
}
