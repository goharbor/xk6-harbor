...
func (o *UpdateGCScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /system/gc/schedule] updateGCSchedule", response, response.Code())
	}
}
...
// Code gets the status code for the update Gc schedule o k response
func (o *UpdateGCScheduleOK) Code() int {
	return 200
}
...
// Code gets the status code for the update Gc schedule bad request response
func (o *UpdateGCScheduleBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the update Gc schedule unauthorized response
func (o *UpdateGCScheduleUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the update Gc schedule forbidden response
func (o *UpdateGCScheduleForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the update Gc schedule internal server error response
func (o *UpdateGCScheduleInternalServerError) Code() int {
	return 500
}
