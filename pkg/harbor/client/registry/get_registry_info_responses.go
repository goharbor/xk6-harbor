...
func (o *GetRegistryInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /registries/{id}/info] getRegistryInfo", response, response.Code())
	}
}
...
// Code gets the status code for the get registry info o k response
func (o *GetRegistryInfoOK) Code() int {
	return 200
}
...
// Code gets the status code for the get registry info unauthorized response
func (o *GetRegistryInfoUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get registry info forbidden response
func (o *GetRegistryInfoForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the get registry info not found response
func (o *GetRegistryInfoNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the get registry info internal server error response
func (o *GetRegistryInfoInternalServerError) Code() int {
	return 500
}
