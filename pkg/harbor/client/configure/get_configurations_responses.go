...
func (o *GetConfigurationsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /configurations] getConfigurations", response, response.Code())
	}
}
...
// Code gets the status code for the get configurations o k response
func (o *GetConfigurationsOK) Code() int {
	return 200
}
...
// Code gets the status code for the get configurations unauthorized response
func (o *GetConfigurationsUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get configurations forbidden response
func (o *GetConfigurationsForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the get configurations internal server error response
func (o *GetConfigurationsInternalServerError) Code() int {
	return 500
}
