...
func (o *ActionPendingJobsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /jobservice/queues/{job_type}] actionPendingJobs", response, response.Code())
	}
}
...
// Code gets the status code for the action pending jobs o k response
func (o *ActionPendingJobsOK) Code() int {
	return 200
}
...
// Code gets the status code for the action pending jobs unauthorized response
func (o *ActionPendingJobsUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the action pending jobs forbidden response
func (o *ActionPendingJobsForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the action pending jobs not found response
func (o *ActionPendingJobsNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the action pending jobs unprocessable entity response
func (o *ActionPendingJobsUnprocessableEntity) Code() int {
	return 422
}
...
// Code gets the status code for the action pending jobs internal server error response
func (o *ActionPendingJobsInternalServerError) Code() int {
	return 500
}
