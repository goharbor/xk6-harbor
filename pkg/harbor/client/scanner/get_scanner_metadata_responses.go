...
func (o *GetScannerMetadataReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /scanners/{registration_id}/metadata] getScannerMetadata", response, response.Code())
	}
}
...
// Code gets the status code for the get scanner metadata o k response
func (o *GetScannerMetadataOK) Code() int {
	return 200
}
...
// Code gets the status code for the get scanner metadata unauthorized response
func (o *GetScannerMetadataUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get scanner metadata forbidden response
func (o *GetScannerMetadataForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the get scanner metadata internal server error response
func (o *GetScannerMetadataInternalServerError) Code() int {
	return 500
}
