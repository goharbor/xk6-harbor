...
func (o *GetScanAllScheduleReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /system/scanAll/schedule] getScanAllSchedule", response, response.Code())
	}
}
...
func (o *GetScanAllScheduleUnauthorized) Code() int {
	return 401
}
...
func (o *GetScanAllSchedulePreconditionFailed) Code() int {
	return 412
}
...
func (o *GetScanAllScheduleInternalServerError) Code() int {
	return 500
}
