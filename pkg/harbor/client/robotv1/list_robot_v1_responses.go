...
func (o *ListRobotV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /projects/{project_name_or_id}/robots] ListRobotV1", response, response.Code())
	}
}
...
func (o *ListRobotV1InternalServerError) Code() int {
	return 500
}
