...
func (o *GetRetentionTaskLogReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /retentions/{id}/executions/{eid}/tasks/{tid}] getRetentionTaskLog", response, response.Code())
	}
}
...
// Code gets the status code for the get retention task log o k response
func (o *GetRetentionTaskLogOK) Code() int {
	return 200
}
...
// Code gets the status code for the get retention task log unauthorized response
func (o *GetRetentionTaskLogUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get retention task log forbidden response
func (o *GetRetentionTaskLogForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the get retention task log internal server error response
func (o *GetRetentionTaskLogInternalServerError) Code() int {
	return 500
}
