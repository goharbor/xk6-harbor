...
func (o *DeleteRetentionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /retentions/{id}] deleteRetention", response, response.Code())
	}
}
...
// Code gets the status code for the delete retention o k response
func (o *DeleteRetentionOK) Code() int {
	return 200
}
...
// Code gets the status code for the delete retention unauthorized response
func (o *DeleteRetentionUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the delete retention forbidden response
func (o *DeleteRetentionForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the delete retention internal server error response
func (o *DeleteRetentionInternalServerError) Code() int {
	return 500
}
