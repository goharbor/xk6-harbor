...
func (o *GetPurgeJobReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /system/purgeaudit/{purge_id}] getPurgeJob", response, response.Code())
	}
}
...
// Code gets the status code for the get purge job o k response
func (o *GetPurgeJobOK) Code() int {
	return 200
}
...
// Code gets the status code for the get purge job unauthorized response
func (o *GetPurgeJobUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the get purge job forbidden response
func (o *GetPurgeJobForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the get purge job not found response
func (o *GetPurgeJobNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the get purge job internal server error response
func (o *GetPurgeJobInternalServerError) Code() int {
	return 500
}
