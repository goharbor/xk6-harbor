...
func (o *CopyArtifactReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /projects/{project_name}/repositories/{repository_name}/artifacts] CopyArtifact", response, response.Code())
	}
}
...
// Code gets the status code for the copy artifact created response
func (o *CopyArtifactCreated) Code() int {
	return 201
}
...
// Code gets the status code for the copy artifact bad request response
func (o *CopyArtifactBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the copy artifact unauthorized response
func (o *CopyArtifactUnauthorized) Code() int {
	return 401
}
...
// Code gets the status code for the copy artifact forbidden response
func (o *CopyArtifactForbidden) Code() int {
	return 403
}
...
// Code gets the status code for the copy artifact not found response
func (o *CopyArtifactNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the copy artifact method not allowed response
func (o *CopyArtifactMethodNotAllowed) Code() int {
	return 405
}
...
// Code gets the status code for the copy artifact internal server error response
func (o *CopyArtifactInternalServerError) Code() int {
	return 500
}
